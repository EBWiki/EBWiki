...
echo ""
echo "Next:"
echo "  1. REVIEW_SERVER=1 bundle exec rake review:deploy_prepare"
echo "     # migrate + ensure sessions + seed (Railway release-tasks.sh runs this on deploy)"
...
echo "  4. Manual sessions fix only if needed: bundle exec rake review:ensure_sessions"
