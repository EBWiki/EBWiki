...
class AnalyticsController < ApplicationController
  ...
  def index
    ...
    @articles_occurring_this_month = Article.most_recent_occurrences 30.days.ago
    @articles_sorted_by_update = Article.sorted_by_update 10
    @articles_sorted_by_followers = Article.sorted_by_followers 10
