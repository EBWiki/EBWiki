...
class CasesController < ApplicationController
  ...
  def update
    ...
    if @this_case.update_attributes(case_params)
      ...
      flash[:undo] = @this_case.versions
      CaseMailer.send_followers_email(users: @this_case.followers, this_case: @this_case).deliver_now
      redirect_to @this_case
    else
      set_instance_vars
      render 'edit'
  ...
  def destroy
    begin
      ...
      flash[:undo] = @this_case.versions
      CaseMailer.send_deletion_email(users: @this_case.followers, this_case: @this_case).deliver_now
